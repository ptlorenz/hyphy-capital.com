...
<html lang="en" dir="ltr">
  <head>
    ...
    <link href="./index81.css" rel="stylesheet" type="text/css">
  ...
  <body style="background-color:#09232eff;background-image: linear-gradient(to right, rgb(14, 47, 61),rgb(23, 130, 125))">
    ...
    <div class="body-content">
      <div class="quant-wrapper">
        ...
        <div class="quant-aum">
          ...
          <div class="quant-aum-figure"> $63,147.29</div>
        </div>
        <div class="quant-apy">
          <div class="quant-apy-text">Current APY</div>
          <div class="quant-apy-figure"> 69%</div>
        </div>
      ...
      <div class="wallet-wrapper">
        <div class="etoro-wrapper">
          <h1>Hyphy Capital Retail Fund Feed & Composition</h1>
          <div class="etoro-address">
            <p><a href="https://www.etoro.com/people/plorenz" target="_blank">Public Etoro Portfolio</a></p>
          </div>
        </div>
      </div>
          ...
          options: {
            plugins: {
              title: {
                ...
                display: true,
                text: 'Weekly Retail Fund Return (Last 3 Months)',
              },
              legend: {
                position: "bottom",
                labels:{
    ...
    async function getData_weekly() {
      ...
      rows.forEach(elt => {
        ...
        const week = row[0];
        xlabels.push(week);
        const fundreturn = row[6];
        yreturns.push(fundreturn);
        const snpreturn = row[7];
          ...
          options: {
            plugins: {
              title: {
                ...
                display: true,
                text: 'Cumulative Retail Fund Return (Last 3 Months)',
              },
              legend: {
                position: "bottom",
                labels:{
    ...
    async function getData_cumulative() {
      ...
      rows.forEach(elt => {
        ...
        const fund_cumulative_return = row[10];
        y_cumulative_returns.push(fund_cumulative_return);
        const snp_cumulative_return = row[11];
