...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Retail Details</title>
    <link rel="preconnect" href="https://fonts.gstatic.com">
    <link href="https://fonts.googleapis.com/css2?family=Lato&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="retail_strategy28.css">
  </head>
    ...
    <div class="container">
      <div class="nav-wrapper">
        ...
        <div class="right-side">
          <div class="brand">
            <p><a href="https://metamask.io/" class="button-wallet"> Connect Metamask</a></p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="quant-wrapper">
        ...
        <div class="nav-wrapper-quant">
          <div class="left-side">
            <div class="stat-brand">
              <p><a href="retail.html" class="button-quant">Statistics</a></p>
            </div>
      ...
      <div class="description-wrapper">
        ...
        <div class="description-text"> <p>Hyphy Capital's Quantitative Fund is a mathematical Fund based on a combination of Google's Open-Source Keras Deep Learning Library, PyTorch, and ExtraGradientBoost that aims to completely eliminate human decision making and is solely based on historic and live financial data. The fund's models are
          ...
          <p>Numerai does this by accepting <a href="https://www.kraken.com/en-us/learn/what-is-numeraire-nmr" target="_blank">Numeraire (NMR)</a>, their in-house ERC-20 token built on the Ethereum Blockchain. Particpants can use NMR to 'stake'
          on their own models. Numerai then pays out NMR to each model, depending on its accuracy. Hyphy Capital's Quant Fund submits 4-6 models (depending on data and compute availability), which are used to submit signals on Numerai. Thus, the Fund's Current AUM is, in reality, denominated in NMR. Though the Fund keeps a liquid NMR
          cushion (5-10% of the total AUM) that is not 'staked' towards the deployed models. This is to remain adaptable to market conditions if necessary ('unstaking' NMR from Numerai may take about 28 days). </p>
          ...
          <a href="https://etherscan.io/address/0x0000000000000000000000000000000000021aed#tokentxns" target="_blank">Numerai Signals Leaderboard</a>.</p></div>
            ...
            <div class="card-model-wrapper">
              <div class="card-patrickl">
                <div class="card-content">
                  ...
                  <h2 class="card-title-left">$BTC - EPS Valuation Model</h2>
            ...
            <div class="card-model-wrapper">
              <div class="card-patrickl2">
                <div class="card-content">
                  ...
                  <h2 class="card-title-left">$TSLA - EPS Valuation Model</h2>
          ...
          <div class="card-model-wrapper">
            <div class="card-left">
              <div class="card-content">
                ...
                <h2 class="card-title-left">$SQ - EPS Valuation Model</h2>
